...
@Entity
@Table(name = "project")
@NamedQueries({@NamedQuery(name = "Project.findAll", query = "SELECT p FROM Project p"), @NamedQuery(name = "Project.findByClientName", query = "SELECT p FROM Project p WHERE p.projectPK.clientName = :clientName"), @NamedQuery(name = "Project.findByClientDepartmentNumber", query = "SELECT p FROM Project p WHERE p.projectPK.clientDepartmentNumber = :clientDepartmentNumber"), @NamedQuery(name = "Project.findByProjectName", query = "SELECT p FROM Project p WHERE p.projectPK.projectName = :projectName"), @NamedQuery(name = "Project.findByContactEmail", query = "SELECT p FROM Project p WHERE p.contactEmail = :contactEmail"), @NamedQuery(name = "Project.findByContactPassword", query = "SELECT p FROM Project p WHERE p.contactPassword = :contactPassword")})
