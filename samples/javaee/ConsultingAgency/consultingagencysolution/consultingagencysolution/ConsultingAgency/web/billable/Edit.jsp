        ...
        <body>
            ...
            <h:form id="form1">
                ...
                <h:panelGrid columns="2">
                    ...
                    <h:inputText id="startDate" value="#{billable.billable.startDate}" title="StartDate" onkeyup="AjaxUtil.fireValidationAjaxTransaction(this);" converterMessage="Invalid start date.">
