...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Billable</h1>
            <h:form id="form1">
                <h:inputHidden id="validateCreateField" validator="#{billable.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{billable.create}" value="Create"/>
                <br />
                <br />
